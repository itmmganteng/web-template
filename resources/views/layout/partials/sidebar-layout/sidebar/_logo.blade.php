...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	...
	<a href="{{ route('dashboard') }}">
        <div class="app-sidebar-logo-default d-flex align-items-center theme-light-show">
            <img alt="Logo" src="{{ asset('assets/media/logos/m-mart.svg') }}" class="h-40px app-sidebar-logo-default" />
        ...
        <img alt="Logo" src="{{ asset('assets/media/logos/m-mart.svg')}}" class="h-30px app-sidebar-logo-minimize"/>
	</a>
	<!--end::Logo image-->
