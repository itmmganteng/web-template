...
class BootstrapDefault
{
    public function init()
    {
        ...
        // 5) M Mart layout (default.html)
        $this->initMMartLayout();
    ...
    public function initMMartLayout()
    {
        addHtmlAttribute('body', 'data-kt-app-layout', 'light-sidebar');
        addHtmlAttribute('body', 'data-kt-app-header-fixed', 'true');
        addHtmlAttribute('body', 'data-kt-app-sidebar-enabled', 'true');
        ...
        addHtmlAttribute('body', 'data-kt-app-toolbar-enabled', 'true');
        addHtmlAttribute('body', 'data-kt-app-page-loading-enabled', 'true');
        addHtmlAttribute('body', 'data-kt-app-page-loading', 'on');
        addHtmlAttribute('body', 'data-kt-app-header-fixed-mobile', 'true');
